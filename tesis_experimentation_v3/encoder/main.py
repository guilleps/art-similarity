...
def main():
    ...
    embeddings_base_folder = r"C:\workspace\tesis_project\experimentation\tesis_experimentation_v3\encoder\images\2\embeddings"
    input_images_folder = r"C:\workspace\tesis_project\experimentation\tesis_experimentation_v3\encoder\images\2"
    ...
    image1_folder = os.path.join(embeddings_base_folder, "albert-julius")
    image2_folder = os.path.join(embeddings_base_folder, "antoine-blanchard")
