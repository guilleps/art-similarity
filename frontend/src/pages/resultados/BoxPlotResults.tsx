...
import { BoxPlotResultsChart } from '@/components/BoxPlotResultsChart';
import { useBoxPlotResultsData } from '@/hooks/useBoxPlotResultsData';

export const BoxPlotResults = () => {
	const { data, isLoading, isError, results, extremes } = useBoxPlotResultsData();
		...
		<div className="min-h-screen flex flex-col justify-center px-6 items-center">
			...
			<div className="w-full max-w-6xl space-y-6">
				<div className="relative w-full h-[28rem] bg-white">
					...
					<BoxPlotResultsChart results={results} />
				</div>
